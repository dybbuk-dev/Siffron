...
import OrganizationProfileFormModal from 'src/view/organizationProfile/form/OrganizationProfileFormModal';
import AutocompleteInMemoryFormItem from 'src/view/shared/form/items/AutocompleteInMemoryFormItem';
import { useFormContext } from 'react-hook-form';
import { useSelector } from 'react-redux';
import selectors from 'src/modules/organizationProfile/organizationProfileSelectors';

function OrganizationProfileAutocompleteFormItem(props) {
  ...
  const fetchFn = (value, limit) => {
    return OrganizationProfileService.listAutocomplete(
      value,
      limit,
    );
  };
...
export default OrganizationProfileAutocompleteFormItem;
