...
import actions from 'src/modules/section/importer/sectionImporterActions';
...
function SectionImportPage() {
  const Importer = importerHoc(
    selectors,
    actions,
    fields,
    i18n('entities.section.importer.hint'),
  );
...
export default SectionImportPage;
