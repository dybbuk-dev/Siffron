...
function TaskPriorityToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    taskPrioritySelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    taskPrioritySelectors.selectPermissionToImport,
  );
    ...
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <MDButton
          ...
          color={sidenavColor}
          component={Link}
          to="/audit-logs?entityNames=taskPriority"
...
export default TaskPriorityToolbar;
