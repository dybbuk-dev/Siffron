...
const schema = yup.object().shape({
  ...
  popularityRange: yupFilterSchemas.integerRange(
    i18n('entities.product.fields.popularityRange'),
  ),
});
...
const previewRenders = {
  ...
  popularityRange: {
    label: i18n('entities.product.fields.popularityRange'),
    render: filterRenders.range(),
  },
};
              ...
              <Grid container spacing={2}>
                ...
                <Grid item lg={6} xs={12}>
                  <InputNumberRangeFormItem
                    ...
                    label={i18n(
                      'entities.product.fields.popularityRange',
                    )}
                    variant="standard"
                  />
                </Grid>
