...
function FacingToolbar(props) {
  ...
  const hasPermissionToCreate = useSelector(
    facingSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    facingSelectors.selectPermissionToImport,
  );
    ...
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <MDButton
          ...
          color={sidenavColor}
          component={Link}
          to="/audit-logs?entityNames=facing"
